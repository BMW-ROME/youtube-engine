...
- [~ ] Phase 4: Metadata & Distribution — core/seo_optimizer.py, core/shorts_gen.py, core/uploader.py, core/pipedream_uploader.py core/seo_optimizer.py DONE and committed 2026-08-15 (Stage 8: GPT-4o SEO metadata generation — title/description/tags/hashtags/pinned comment/end-screen topics, same ChatClient + retry-then-raise pattern as script_writer.py). Remaining: shorts_gen.py, uploader.py, pipedream_uploader.py.
